...
TIME_PENALTY = -1 # Penalty for time passing. To avoid stalls.
MICROTIME_PENALTY = TIME_PENALTY / 100 # Changes the Q values by a small amount to avoid persistent actions
